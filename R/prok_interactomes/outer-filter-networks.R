# Write networks at 50% precision.
...
# set up input files
input_dir = file.path(base_dir, 'prok_interactomes')
...
write_sh(job_name = 'prok-interactomes',
         sh_file = sh_file,
         grid_file = grid_file,
         inner_file = 'R/prok_interactomes/inner-filter-networks.R',
         system = system,
         time = 8,
         mem = 72)
