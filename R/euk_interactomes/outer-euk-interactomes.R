...
# parse arguments
parser = ArgumentParser(prog = 'outer-euk-interactomes.R')
...
# set up output files
output_dir = file.path(base_dir, 'euk_interactomes')
...
# write
grid_file = "sh/grids/euk-interactomes.txt"
...
sh_file = '~/git/CFdb-analysis/sh/euk-interactomes.sh'
write_sh(job_name = 'euk-interactomes',
         sh_file = sh_file,
         grid_file = grid_file,
         inner_file = 'R/euk_interactomes/inner-euk-interactomes.R',
         system = system,
         time = 48,
         mem = 180)
